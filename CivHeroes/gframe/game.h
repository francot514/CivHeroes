...
public:
	...
	//campaign menu
	irr::gui::IGUIWindow* wCampaignMenu;
	irr::gui::IGUIButton* btnStartC;
	irr::gui::IGUIButton* btnCancelC;
	irr::gui::IGUIComboBox* cRaceC;
	irr::gui::IGUIListBox* lstCPlayList;
	irr::gui::IGUIStaticText* stRaceC;
	irr::gui::IGUIStaticText* stStatus;
	irr::gui::IGUIStaticText* stStatusC;
	irr::gui::IGUIStaticText* stProgress;
	irr::gui::IGUIStaticText* stProgressC;
	irr::gui::IGUIStaticText* stProgressT;
	//quick host
	...
	irr::gui::IGUIComboBox* cbLanguageSelect;
	irr::gui::IGUIComboBox* cbRenderSelect;
	irr::gui::IGUIComboBox* cbSkinSelect;
	irr::gui::IGUICheckBox* chkEnableMods;
	irr::gui::IGUICheckBox* chkEnableAdvanceGraphics;
	//hand
	...
	//avatar image
	irr::gui::IGUIImage* imgAvatar;
	irr::gui::IGUIImage* imgAvatar2;
	//deck edit
...
//online mode
#define BUTTON_CAMPAIGN_JOIN		1050
#define BUTTON_CAMPAIGN_CANCEL		1051
...
#define COMBOBOX_CTYPE				1059
//configurations
#define CHECKBOX_ENABLE_MODS		1060
#define CHECKBOX_ENABLE_GRAPHICS	1061
#define COMBOBOX_LANGUAGE			1062
#define COMBOBOX_RENDERER			1063
#define COMBOBOX_SKIN				1064
#define LISTBOX_MODS_LIST			1065
